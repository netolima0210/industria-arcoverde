    ...
    return (
        ...
        >
            <div className={cn(
                ...
                <div className="flex-1 w-full flex items-center justify-center relative min-h-[280px] md:min-h-[400px]">
                    <div className="absolute inset-0 bg-white/30 backdrop-blur-sm rounded-full md:rounded-3xl md:translate-x-4 md:translate-y-4 transition-transform group-hover:translate-x-6 group-hover:translate-y-6" />

                    <div className="relative z-10 w-full h-full flex items-center justify-center">
                        {imageSrc ? (
                            <div className="relative w-[280px] h-[280px] md:w-full md:h-[400px] rounded-full md:rounded-3xl overflow-hidden shadow-lg">
                                <Image
                                    src={imageSrc}
                                    alt={title}
                                    fill
                            ...
                            <div className="w-[280px] h-[280px] md:w-full md:h-[400px] border-4 border-dashed border-gray-300/50 rounded-full md:rounded-3xl flex flex-col items-center justify-center text-center p-6 bg-white/50">
