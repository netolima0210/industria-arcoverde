...
import { getProductBySlugFeneme } from "@/data/linha-feneme";
...
export default function ProductDetailPage() {
    ...
    const produto = getProductBySlugFeneme(slug);
    ...
    return (
        <main className="min-h-screen pt-28 pb-16 bg-gradient-to-br from-gray-50 to-blue-50/30">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        ...
                        {/* Slogan */}
                        {produto.slogan && (
                            <p className="text-xl md:text-2xl font-semibold text-blue-600 leading-relaxed">
                                {produto.slogan}
                            </p>
                        )}
