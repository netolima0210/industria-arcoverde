...
import { getProductBySlugRevolus } from "@/data/linha-revolus";
...
export default function ProductDetailPage() {
    ...
    const produto = getProductBySlugRevolus(slug);
    ...
    return (
        <main className="min-h-screen pt-28 pb-16 bg-gradient-to-br from-gray-50 to-yellow-50/30">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        {/* Categoria */}
                        <span className="inline-block px-4 py-1.5 bg-yellow-100 text-yellow-700 rounded-full text-sm font-semibold">
                            {produto.categoria}
                        </span>
                        ...
                        {/* Slogan */}
                        {produto.slogan && (
                            <p className="text-xl md:text-2xl font-semibold text-yellow-600 leading-relaxed">
                                {produto.slogan}
                            </p>
                        )}
