            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="space-y-4">
                        <div className="relative w-48 h-16">
                            ...
                            <span className="text-2xl font-bold text-primary tracking-tight">Indústria Arcoverde</span>
                        </div>
                ...
                <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row items-center justify-between text-sm text-gray-400">
                    ...
                    <p className="mt-2 md:mt-0">
                        Desenvolvido por <span className="font-semibold text-gray-600">SevenCode</span>
                    </p>
                </div>
            </div>
        </footer>
